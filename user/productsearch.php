...
?>
  ...
  <body>
    ...
    <div class="navigation">
		...
		<button type="submit" style="transform: translateY(137px); border-top: none;
																							  border-right: none;
																							  border-left: none;
		...
		<input type="text" name="search_query" id="rawr" placeholder="Search here ..." style="transform: translateY(138px); border-top: none;
																							  border-right: none;
																							  border-left: none;
																							  border-bottom: 1px solid #A9A9A9;
																							outline: none;
...
if (isset($_GET["search_query"])) {
    ...
    $search_term = '%'; // Default search term to match everything if not provided
}

// Prepare the SQL statement
$stmt = $conn->prepare("SELECT id, name_item, type, discount, price, image_front 
                       FROM products 
                       WHERE name_item LIKE ? 
                          OR type LIKE ? 
                          OR discount LIKE ? 
                          OR price LIKE ?
                       ORDER BY price ASC
...
// Bind parameters
$stmt->bind_param("ssssii", $search_term, $search_term, $search_term, $search_term, $productsPerPage, $offset);
...
// Display your results or pagination here
?>
