...
<!-- All Products -->
    <section class="section all-products" id="products">
		...
		// Prepare the SQL query to retrieve products for the current page
		$stmt = $conn->prepare("SELECT id, name_item, type, discount, price, image_front FROM products ORDER BY price ASC LIMIT ? OFFSET ?");
