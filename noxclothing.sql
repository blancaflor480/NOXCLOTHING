...
(1, 'admin', '', '', 'admin@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin', '', '2024-05-07', '2024-05-19 14:27:31');
...
(2, 'Jade ', '', '', 'bryanblancaflor007@gmail.com', 'admin', '', '', 0, 0, '2024-05-14', '', '21232f297a57a5a743894a0e4a801fc3', '2024-05-14');
...
INSERT INTO `orders` (`id`, `customer_id`, `products_id`, `innovoice`, `price`, `quantity`, `color`, `size`, `status`, `total_amount`, `order_date`) VALUES
(1, 2, 5, 1235555, 299.00, 1, 'green', 'Medium', 'Pending', 299.00, '2024-05-19');
