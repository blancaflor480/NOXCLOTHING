...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2024 at 05:05 PM
...
(1, 'admin', '', '', 'admin@gmail.com', 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin', '', '2024-05-07', '2024-05-13 16:57:35');
...
INSERT INTO `customer` (`id`, `fname`, `mname`, `lname`, `email`, `uname`, `address`, `city`, `zipcode`, `contactnumber`, `bday`, `image`, `password`, `datereg`) VALUES
...
INSERT INTO `products` (`id`, `name_item`, `type`, `color`, `size`, `manufacturer`, `description`, `category`, `quantity`, `status`, `image_front`, `image_back`, `discount`, `price`) VALUES
(1, 'Boys', 'male', 'black', 'large', 'Nike', 'HAHHA', 'SHORTS', 12, 'Restock', 0x637962657270756e6b2e6a7067, '', 50.00, 1020.25),
(2, 'tshirt', 'male', 'Blue', 'small', 'Nike', 'ahshashdashd', 'T-SHIRT', 10, 'Low Stock', 0x3432333435343438365f313135383131353836323232363536395f353733323736303638323539393132333030345f6e2e706e67, '', 10.00, 500.00);
