    ...
    <section class="section all-products" id="products">
        <div class="top container">
            ...
            function redirect() {
                ...
                var url = '';
                if (selectedValue == "1") url = "product.php";
                else if (selectedValue == "2") url = "sortbyprice.php";
                else if (selectedValue == "3") url = "sortbypopularity.php";
                else if (selectedValue == "4") url = "sortbysale.php";
                else if (selectedValue == "5") url = "sortbyrating.php";
        ...
        $stmt = $conn->prepare("SELECT p.id, p.name_item, p.type, p.discount, p.price, p.image_front, COUNT(ac.id) AS cart_count 
                        FROM products p 
                        LEFT JOIN addcart ac ON p.id = ac.products_id 
                        GROUP BY p.id 
                        ORDER BY cart_count DESC, p.price ASC LIMIT ? OFFSET ?");
